...
<head>
  ...
  <title>OMBUDSMAN - WHISTLE BLOWING SYSTEM - Login</title>

  <!-- Custom fonts for this template-->
  <link href="<?php echo base_url()?>/assets/plugins/bootstrap.css">
  ...
  <link href="<?php echo base_url()?>/css/sb-admin-2.min.css" rel="stylesheet">
   <link href="<?php echo base_url()?>/assets/plugins/bootstrap.css" rel="stylesheet">
      ...
      <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-lg-5 d-none d-lg-block" style="margin-top: 70px">
            <center>
             <img src="<?php echo base_url()?>assets/img/ombudsman.png" style="width: 250px" />
             </center>
          </div>
